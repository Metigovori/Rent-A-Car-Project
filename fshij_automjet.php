...
<section class="section-shto-modifiko container">
    ...
    <div class="forma">
        ...
        <div class="inputAndLabels">
                ...
                <select disabled id="kemri" name="kemri">
                    <?php
                    //echo $_GET['rid'];
                    if (isset($_GET['aid'])) {
            ...
            <div class="inputAndLabels">
                <div class="butonat">
                    ...
                    if (!isset($_GET['aid'])) {
                        ...
                        echo "<input id='fshijautomjet' type='submit'
                            name='fshijautomjet' class='shtoModifiko' value='Fshij Automjet'>";
                    }
                    ?>
                </div>
            </div>
