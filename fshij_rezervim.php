    ...
    <div class="forma">
        ...
        <form method="POST">
            <div class="inputAndLabels">
                ...
                <select disabled id="klienti" name="klienti">
                    <?php
                    //echo $_GET['rid'];
                    if (isset($_GET['rid'])) {
            ...
            <div class="inputAndLabels">
                ...
                <select disabled id="automjeti" name="automjeti">
                    <?php
                    //echo $_GET['rid'];
                    if (isset($_GET['rid'])) {
                    ...
                    while ($automjeti = mysqli_fetch_assoc($automjetet)) {
                        ...
                        if (!empty($autoid)) {
                            if ($autoid != $automjetiid) {
                                echo "<option value='$automjetiemri'> $automjetiemri</option>";
                            }
                        } else {
                            echo "<option value='$automjetiemri'> $automjetiemri</option>";
                        }
            ...
            <div class="inputAndLabels">
                ...
                <input disabled type="date" id="datamarrjes" name="datamarrjes"
                value="<?php if(!empty($dataemarrjes)) echo $dataemarrjes ?>">
            </div>
            <div class="inputAndLabels">
                <label for="datakthimit">Data e kthimit</label> <br>
                <input disabled type="date" id="datakthimit" name="datakthimit"
